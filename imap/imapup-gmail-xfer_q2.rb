...
def copy_folder_messages(source, source_folder, dest, dest_folder)
  ...
  # use SizedQueue for multithreaded processing
  ...
  reader_thread = Thread.new do
	...
	next
      ...
      ds "downloading message (#{source_folder}) #{mid[0..15]} [#{msg_num}/#{source_count}] q#{queue.length}..."
